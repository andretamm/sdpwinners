...
/**
 * Behavior for the first milestone - robot moves to the white line,
 * traces the field and stops where it first saw the white line
 * 
 * @author Andre
 *
 */
public class Milestone1 implements Behavior {
	
	boolean isActive = false; // If this behavior is active
